...
_x_ 1 pt: All expected attributes for `Computer` class are present

_x_ 1 pt: All expected methods for `Computer` class are present

_x_ 1 pt: Constructor for `Computer` class is present and sets attributes correctly
